...
* :+1::+1::+1:[Iris](https://github.com/kataras/iris)： 比较新,很炫,可使用至少6种模板引擎,支持自定义序列化引擎,支持动态子域名,支持具名路径参数...总之,很炫酷,并且执行效率比以上所有的框架都高。自称是地球上最快的 Go 语言 Web 框架, [相关文档](https://suifengtec.gitbooks.io/iris-cn/content/)。
